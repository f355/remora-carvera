...
void ERR0_callback(void) { error("Oh no! My Mbed EXPLODED! :( Only kidding, go find the problem"); }
...
// Configuration callback on Error
void ERR1_callback(void) { error("Oh no! My Mbed EXPLODED! :( Only kidding, go find the problem"); }
