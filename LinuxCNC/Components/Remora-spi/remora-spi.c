...
int rt_peripheral_init(void)
{
    ...
    else if (rp1 == true)
    {
        ...
        rp1spi_init(0, 0, SPI_MODE_0, 40000000); // SPIx, CSx, mode, freq. Clock frequency here is different than Pi4, this will get rounded to nearest clock divider. TODO Figure out exact value that works best with Flexi.
    }
    else
    {
        return -1;
